...
- [leaderless.zip](https://github.com/LiviaSongster/leaderless_Aphalloides/blob/main/Software%20S1/leaderless.zip): Scripts have been updated to accommodate leaderless MSDINs by Milton T. Drott for the manuscript entitled <i>[Leaderless RiPPs expand the chemical repertoire of the invasive death cap mushroom](https://www.pnas.org/)</i>. Please cite accordingly if using the leaderless portion of the pipeline 
